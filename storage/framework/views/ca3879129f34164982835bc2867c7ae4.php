...
<?php $__env->startSection('page_title', 'Edit Data Penulis'); ?>
...
<div class="max-w-4xl mx-auto p-6">
    ...
    <div class="glass rounded-3xl p-8 shadow-xl bg-white/50 backdrop-blur-lg">
        <form action="<?php echo e(route('penulis.update', $penulis->id)); ?>" method="POST" enctype="multipart/form-data" class="space-y-6">
            <?php echo csrf_field(); ?>
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                <div>
                    ...
                    <input type="text" name="nama_depan" value="<?php echo e(old('nama_depan', $penulis->nama_depan)); ?>" 
                ...
                <div>
                    ...
                    <input type="text" name="nama_belakang" value="<?php echo e(old('nama_belakang', $penulis->nama_belakang)); ?>" 
                           class="w-full px-4 py-3 rounded-xl border border-gray-200 focus:ring-2 focus:ring-purple-500 focus:outline-none transition-all" required>
                </div>
            </div>
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                <div>
                    ...
                    <input type="text" name="user_name" value="<?php echo e(old('user_name', $penulis->user_name)); ?>" 
                           class="w-full px-4 py-3 rounded-xl border border-gray-200 focus:ring-2 focus:ring-purple-500 focus:outline-none transition-all" required>
                </div>
                <div>
            ...
            <div>
                ...
                <?php if($penulis->foto): ?>
                    <div class="mb-4">
                        ...
                        <img src="<?php echo e(asset('storage/' . $penulis->foto)); ?>" class="w-24 h-24 rounded-full object-cover shadow-sm border border-white">
                    </div>
                <?php endif; ?>
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH /Applications/XAMPP/xamppfiles/htdocs/aplikasi-blog/resources/views/penulis/edit.blade.php ENDPATH**/ ?>