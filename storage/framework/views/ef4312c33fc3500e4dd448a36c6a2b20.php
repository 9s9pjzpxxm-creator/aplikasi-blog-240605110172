<header class="flex justify-between items-center px-8 py-6 border-b border-white/50">
    ...
    <div class="flex items-center gap-5">
        ...
        <a href="<?php echo e(route('front.index')); ?>" target="_blank" class="flex items-center gap-2 px-6 py-2.5 bg-[#ecf0f3] neu-shadow rounded-full font-bold text-sm text-purple-600 hover:text-purple-700 active:neu-shadow-inset transition-all border-2 border-white/60">
...
</header><?php /**PATH /Applications/XAMPP/xamppfiles/htdocs/aplikasi-blog/resources/views/components/topbar.blade.php ENDPATH**/ ?>