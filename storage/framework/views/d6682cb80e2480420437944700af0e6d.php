...
<?php $__env->startSection('page_title', 'Edit Data Kategori'); ?>

<?php $__env->startSection('content'); ?>
<div class="max-w-2xl mx-auto p-6">
    <div class="mb-8">
        <h1 class="text-2xl font-bold text-gray-800">Edit Kategori</h1>
        <p class="text-gray-500">Ubah informasi kategori sesuai kebutuhan.</p>
    </div>

    <div class="glass rounded-3xl p-8 shadow-xl bg-white/50 backdrop-blur-lg">
        <form action="<?php echo e(route('kategori.update', $kategori->id)); ?>" method="POST" class="space-y-6">
            <?php echo csrf_field(); ?>
            ...
            <div>
                ...
                <textarea name="keterangan" rows="5" 
                          class="w-full px-4 py-3 rounded-xl border border-gray-200 focus:ring-2 focus:ring-purple-500 focus:outline-none transition-all"><?php echo e(old('keterangan', $kategori->keterangan)); ?></textarea>
            </div>
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH /Applications/XAMPP/xamppfiles/htdocs/aplikasi-blog/resources/views/kategori/edit.blade.php ENDPATH**/ ?>