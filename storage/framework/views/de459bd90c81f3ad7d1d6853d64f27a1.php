...
<body class="text-gray-800 relative min-h-screen flex flex-col overflow-x-hidden">
    ...
    <header class="flex justify-between items-center px-8 py-6 border-b border-white/50 sticky top-0 z-50 glass-premium">
        ...
        <div class="flex items-center gap-6">
            <a href="<?php echo e(route('front.index')); ?>" class="font-bold text-gray-600 hover:text-purple-600 transition-colors">Beranda</a>
            
            <a href="<?php echo e(url('/login')); ?>" class="flex items-center gap-2 px-6 py-2.5 bg-[#ecf0f3] neu-shadow rounded-full font-bold text-sm text-purple-600 hover:text-purple-700 active:neu-shadow-inset transition-all border-2 border-white/60">
...
</html><?php /**PATH /Applications/XAMPP/xamppfiles/htdocs/aplikasi-blog/resources/views/layouts/front.blade.php ENDPATH**/ ?>