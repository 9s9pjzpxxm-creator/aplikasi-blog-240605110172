...
<?php $__env->startSection('page_title', 'Buat Kategori Baru'); ?>
...
<div class="max-w-2xl mx-auto p-6">
    ...
    <div class="glass rounded-3xl p-8 shadow-xl bg-white/50 backdrop-blur-lg">
        <form action="<?php echo e(route('kategori.store')); ?>" method="POST" class="space-y-6">
            <?php echo csrf_field(); ?>
            ...
            <div>
                ...
                <input type="text" name="nama_kategori" 
                       ...
                       placeholder="Contoh: Teknologi" value="<?php echo e(old('nama_kategori')); ?>" required>
            </div>
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH /Applications/XAMPP/xamppfiles/htdocs/aplikasi-blog/resources/views/kategori/create.blade.php ENDPATH**/ ?>