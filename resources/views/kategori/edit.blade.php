        ...
        <form action="{{ route('kategori.update', $kategori->id) }}" method="POST" class="space-y-6">
            ...
            <div>
                ...
                <textarea name="keterangan" rows="5" 
                          class="w-full px-4 py-3 rounded-xl border border-gray-200 focus:ring-2 focus:ring-purple-500 focus:outline-none transition-all">{{ old('keterangan', $kategori->keterangan) }}</textarea>
            </div>
